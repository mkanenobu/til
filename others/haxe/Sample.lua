...
Sample.main = function() 
  haxe.Log.trace("Hello, World!",_hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="Sample.hx",lineNumber=3,className="Sample",methodName="main"}));
end
